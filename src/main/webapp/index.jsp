...
<body>
  ...
  <p><em>***<b>Breaking News: AlphaGo has won the first two matches!</b>*** In this, the third in our series on the epic Go matches being played <br>between AlphaGo (Google’s Artificial Intelligence software) and Lee Se-Dol (Current Go World Champion), we look at the history of</br> Humans vs. Machines, and the innovations that have led us to this incredible moment in time.</em></p>
  ...
  <p><em>The game of Go has long been viewed as the most challenging of classic games for artificial intelligence due to its enormous search space<br> and the difficulty of evaluating board positions and moves.</br></em></p>

  <p> Put another way, winning at Go is a kind of Holy Grail for those who strive to create machines that can “think” on their own, because<br> success at this uniquely complex game seems to require something more than just skill, knowledge, and experience. It requires intuition.</br> Feel. Style. Characteristics we associate with humans, not with machines.</p>
